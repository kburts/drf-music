(function() {
  ...
  app.controller('PlaylistCtrl', [
    'Playlist', 'YoutubePlayerService', 'Queue', '$routeParams', '$scope', '$log', function(Playlist, YoutubePlayerService, Queue, $routeParams, $scope, $log) {
      $scope.hello = 'hello';
  ...
  app.controller('PlaylistListCtrl', [
    'PlaylistList', '$scope', function(PlaylistList, $scope) {
